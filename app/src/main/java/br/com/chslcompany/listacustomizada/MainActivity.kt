...
import br.com.chslcompany.listacustomizada.adapter.ListaChurrasPersonalizado
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val listaAdapterPersonalizada = ListaChurrasPersonalizado(listaDeConvidados(), this)
        listaChurras.adapter = listaAdapterPersonalizada
